...
function App() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-6 bg-gray-900 text-white">
      ...
      {/* Form */}
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white bg-opacity-20 backdrop-blur-lg p-6 rounded-xl shadow-lg border border-gray-500">
        <input
          type="text"
          name="name"
          placeholder="Name"
          ...
          className="w-full p-3 mb-3 border rounded-md text-gray-900 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
          required
        />
        <input
          type="email"
